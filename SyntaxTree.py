...
class SyntaxTree(object):
    ...
    #Clase del arbol: funciona para poder recibir una expresion regular y a partir de esta genera 
    #un arbol segun los operadores.
    
    # parametros de los operadores: lista de operadores definidos por el arbol, regex y el root (raíz del arbol)
